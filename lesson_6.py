...
button_3: KeyboardButton = KeyboardButton(text='Обещаю')
button_4: KeyboardButton = KeyboardButton(text='Сделаю прям сейчас!')


# Создаем объект клавиатуры, добавляя в него кнопки
keyboard: ReplyKeyboardMarkup = ReplyKeyboardMarkup(
                                    keyboard=[[button_1, button_2]])
keyboard_two: ReplyKeyboardMarkup = ReplyKeyboardMarkup(
                                    keyboard=[[button_3, button_4]])
...
async def process_dog_answer(message: Message):
    ...
    await message.answer(text='Дальше!',
